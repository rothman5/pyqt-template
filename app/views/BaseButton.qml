...
Button {
    ...
    icon.color: Qt.darker(button.surfaceTextColor, 1.2)
    ...
    background: Rectangle {
        ...
        color: button.pressed ? button.pressedColor : button.hovered ? button.hoveredColor : button.surfaceColor
        border.color: button.pressed ? button.pressedBorderColor : button.hovered ? button.hoveredBorderColor : button.borderColor
